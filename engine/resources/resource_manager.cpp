...
font_resource_wrapper_ptr resource_manager::load_font_wrapper(const std::string &path)
{
    AEON_LOG_DEBUG(logger_) << "Loading font resource wrapper '" << path << "'." << std::endl;
    ...
    return std::make_shared<font_resource_wrapper>(*this, real_path, best_match_provider);
}
