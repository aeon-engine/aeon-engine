...
DEFINE_EXCEPTION_OBJECT(resource_exception, aeon::common::exception, "Generic resource exception.");
...
// codec
DEFINE_EXCEPTION_OBJECT(codec_exception, codec_manager_exception, "Generic Codec exception.");
